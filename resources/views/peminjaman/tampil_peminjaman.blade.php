...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">UPDATE PEMINJAMAN</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Update Peminjaman</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endphp
                            @endif
                            <form action="{{ route('peminjaman.peminjaman_update', $peminjaman->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-sm-8 mb-3">
                                                    <select class="form-control" name="is_internal">
                                                        <option value="0" @if($peminjaman->is_internal == 0) selected @endif>Tidak</option>
                                                        <option value="1" @if($peminjaman->is_internal == 1) selected @endif>Ya</option>
                                                    </select>
                                                </div>
                                                @error('judul')
                                                <div class="alert alert-danger">{{ $message }}</div>
