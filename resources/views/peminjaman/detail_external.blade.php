                ...
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endphp
                            @endif
                            <form action="{{ route('peminjaman.simpanPinjamanEksternal',$id_peminjaman)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="hidden" class="form-control" id="no_kontak" name="id_admin" value="{{ auth()->user()->id }}">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <div class="col-sm-4">
