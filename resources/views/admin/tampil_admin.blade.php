                ...
                <div class="card-body">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endphp
                            @endif
                            <form action="{{ route('admin.admin_update', $admin->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card shadow mb-4">
                                            <div class="card-body">
                                                <!-- <div class="form-group row mb-3">
                                                    <div class="col-sm-4">
                                                        <img src="{{ asset('gambar/' . $admin->gambar) }}" width="200" height="400" alt="gambar">
                                                    </div>
                                                </div> -->
                                                @error('judul')
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-sm-4">
                                                    <label class="form-text" style="text-align:left">Nama Admin </label>
                                                </div>
                                                <div class="col-sm-8">
